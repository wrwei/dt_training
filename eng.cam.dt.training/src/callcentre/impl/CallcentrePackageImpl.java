...
import callcentre.CallRedirection;
import callcentre.CallcentreFactory;
import callcentre.CallcentrePackage;
import callcentre.Decision;
import callcentre.InputQuestion;
import callcentre.Model;
 ...
 * @generated
 */
public class CallcentrePackageImpl extends EPackageImpl implements CallcentrePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	private EClass callRedirectionEClass = null;
	 ...
	 * @generated
	 */
	private EClass inputQuestionEClass = null;
	 ...
	 * @see callcentre.CallcentrePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private CallcentrePackageImpl() {
		super(eNS_URI, CallcentreFactory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link CallcentrePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static CallcentrePackage init() {
		if (isInited) return (CallcentrePackage)EPackage.Registry.INSTANCE.getEPackage(CallcentrePackage.eNS_URI);

		// Obtain or create and register package
		Object registeredCallcentrePackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		CallcentrePackageImpl theCallcentrePackage = registeredCallcentrePackage instanceof CallcentrePackageImpl ? (CallcentrePackageImpl)registeredCallcentrePackage : new CallcentrePackageImpl();

		isInited = true;

		// Create package meta-data objects
		theCallcentrePackage.createPackageContents();

		// Initialize created meta-data
		theCallcentrePackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theCallcentrePackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(CallcentrePackage.eNS_URI, theCallcentrePackage);
		return theCallcentrePackage;
	}
	 ...
	 */
	@Override
	public EClass getCallRedirection() {
		return callRedirectionEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getCallRedirection_Number() {
		return (EAttribute)callRedirectionEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EClass getInputQuestion() {
		return inputQuestionEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getInputQuestion_Variable() {
		return (EAttribute)inputQuestionEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		callRedirectionEClass = createEClass(CALL_REDIRECTION);
		createEAttribute(callRedirectionEClass, CALL_REDIRECTION__NUMBER);

		inputQuestionEClass = createEClass(INPUT_QUESTION);
	...
	public void initializePackageContents() {
		...
		callRedirectionEClass.getESuperTypes().add(this.getStep());
		inputQuestionEClass.getESuperTypes().add(this.getStep());
		...
		initEClass(callRedirectionEClass, CallRedirection.class, "CallRedirection", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getCallRedirection_Number(), ecorePackage.getEString(), "number", null, 0, 1, CallRedirection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(inputQuestionEClass, InputQuestion.class, "InputQuestion", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getInputQuestion_Variable(), ecorePackage.getEString(), "variable", null, 0, 1, InputQuestion.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
